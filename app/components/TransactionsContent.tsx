...
export default function TransactionsContent({ transactions, onMarkAsPaid }: TransactionsContentProps) {
  ...
  // #region agent log
  useEffect(() => {
    fetch('http://127.0.0.1:7412/ingest/e41294ac-d718-4cb0-a12d-1333a9614c42',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'31395e'},body:JSON.stringify({sessionId:'31395e',runId:'post-fix',hypothesisId:'A',location:'TransactionsContent.tsx:mount',message:'TransactionsContent render — hardcoded EN?',data:{usesI18n:true,locale,docLang:typeof document!=='undefined'?document.documentElement.lang:'?',hardcodedTitle:t('tx.title')},timestamp:Date.now()})}).catch(()=>{});
  }, [locale, t])
  // #endregion
